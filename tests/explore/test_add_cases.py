...
def test_bidi_tput(playwright: Playwright) -> None:
    """
    Test the bidirectional throughput (Bidi Tput) using Playwright.
    ...
    # page.locator("#state_block_div").get_by_role(
    # "button", name="Attach UE").click()
    ...
    # page.once("dialog", lambda dialog: dialog.dismiss())
    # page.locator("#oneliner46").click()
    #
    # page.once("dialog", lambda dialog: dialog.dismiss())
    # page.locator("#smblocks46").click()
    #
    # page.once("dialog", lambda dialog: dialog.dismiss())
    # page.locator("#word46").click()
    #
    # page.once("dialog", lambda dialog: dialog.dismiss())
...
# pytest -s -v .\test_add_cases.py::test_bidi_tput
# pytest -s -v .\test_add_cases.py
